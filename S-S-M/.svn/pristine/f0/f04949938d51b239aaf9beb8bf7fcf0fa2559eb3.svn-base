...
<html>
	<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath }/skin/js/easyui/form.js"></script>
	</head>
	<body>
		 <form id="form" method="POST" enctype="multipart/form-data">
		 	...
		 	<a id="save" href="javascript:void(0);" 
		 		class="easyui-linkbutton" data-options="iconCls:'icon-ok'" onclick="save()">保存</a>  
		 	<a id="cancel" href="javascript:void(0);" 
		 		class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" onclick="reset()">重置</a>  
		 </form>
	</body>
</html>
